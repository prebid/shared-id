...
public class IpUtil
{
    ...
    public static int ipToInt(String ip) throws IpUtilException
    {
        ...
        return (int)num;        //algorithm says return long, but Simon's team expects integer. we should make sure this is ok.
    }
}
